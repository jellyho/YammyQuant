...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # SECURITY: DB credentials were hardcoded here and are in git history —
        # rotate the password. Read them from the environment instead.
        self.reader = SQLReader(
            host=os.getenv('YQ_DB_HOST'),
            user=os.getenv('YQ_DB_USER'),
            password=os.getenv('YQ_DB_PASSWORD'),
            db=os.getenv('YQ_DB_NAME', 'binance'),
        )
